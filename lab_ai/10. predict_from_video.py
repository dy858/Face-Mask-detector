...
while cap.isOpened():
    ...
    face_locations = face_mask_recognition_model.foward()
    ...
    for i in range(face_locations.shape[2]):
        ...
        cv2.rectangle(result_image, pt1=(left, top), pt2=(right, bottom), thickness=2, color=color, lineType=cv2.LINE_AA)
